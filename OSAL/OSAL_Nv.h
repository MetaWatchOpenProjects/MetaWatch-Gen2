...
// NV page definitions must coincide with segment declaration in "LinkerConfiguration.xcl" file
...
/*! NonVolatile Storage Functions Return Values */
#define NV_SUCCESS                0x00
#define NV_FAILURE                0x01
#define NV_ITEM_UNINIT            0x09
#define NV_OPER_FAILED            0x0A
#define NV_BAD_ITEM_LEN           0x0C

/*! when reading or writing an item an index can be specified */
#define NV_ZERO_OFFSET ( 0) 
